...
response = chain.invoke({"original_question": "Who are some politicians born in Boston?"},config={'callbacks': [ConsoleCallbackHandler()]})
from pprint import pprint
with open('./out.txt', 'w') as f:
    pprint(response, file=f,width=100) 